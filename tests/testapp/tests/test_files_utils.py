...
def test_get_size_display__dir():
    ...
    assert files_utils.get_size_display(path=storage_dir / 'a dir') in ['2.1 kB', '6.2 kB']
    assert files_utils.get_size_display(path=str(storage_dir / 'a dir')) in ['2.1 kB', '6.2 kB']
